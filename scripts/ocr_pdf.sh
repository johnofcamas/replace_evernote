...
DROPBOX_ROOT_DIR="<replace with your dropbox home directory>" # your dropbox root folder
DEST_DIR="${DROPBOX_ROOT_DIR}/Inbox/Searchable"  # this is where you want the final 'searchable' pdf to go
LOG_DIR="${DROBOX_ROOT_DIR}/Documents/Inbox/Log" 
ARCHIVE_DIR="${DROBOX_ROOT_DIR}/ConvertedDocs" # where to move the original non-searchable files when complete
